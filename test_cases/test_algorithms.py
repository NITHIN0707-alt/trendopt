"""
test_cases/test_algorithms.py — TRENDOPT
Unit tests for the three trading algorithms and the signal detector.
...
from brute   import brute_force_max_profit
from greedy  import greedy_max_profit
from dp      import dp_max_profit_with_cooldown
